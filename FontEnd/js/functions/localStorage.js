...
function verifyIsLogged() {
    ...
    if (currentUser['login'] != null || currentUser['id'] != null) {
        ...
        $('.menu-add-tile').html('');
        var logado = "<li class=\"nav-item active\"><a class=\"nav-link\" href=\"#home\">Home</a></li><li class=\"nav-item active\"><a class=\"nav-link\" href=\"#calendary\">Calendário</a></li><li class=\"nav-item active\"><a class=\"nav-link\" href=\"#events\">Meus Eventos</a></li>"+''+"<li class=\"nav-item active btn-exit-account\"><a class=\"nav-link\" href=\"#home\" style=\" color: red;\">Sair</a></li>";
        //<li class=\"nav-item active\"><a class=\"nav-link\" href=\"#notifications\">Notificações</a></li>
